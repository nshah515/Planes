        ...
        <div class="row mt-5">
            ...
            <div class="col-6 offset-3 card border rounded text-white mr-1" style="background-color: black">
                ...
                <label for="name">What would you like to do? </label>
					...
					<a class="nav-link text-light" href="CustomerRepDelete.jsp">
        ...
        <div class="row mt-5">
            ...
            <div class="col-6 offset-3 card border rounded text-white mr-1" style="background-color: black">
				...
				<a class="nav-link text-light" href="editAircraft.jsp">
                    ...
                    <input class="form-control" type="text" id="fnum" name="air" placeholder="Aircraft ID">
                    ...
                    <input class="form-control" type="text" id="fnum" placeholder="Aircraft ID">
        ...
        <div class="row mt-5">
            ...
            <div class="col-6 offset-3 card border rounded text-white mr-1" style="background-color: black">
                ...
                <label for="name">What would you like to do? </label>
                	...
                	<a class="nav-link text-light" href="AddAirportCRBackend.jsp">
                	
                	<div class="form-group mt-3">

                    <label for="name">Airport ID : </label>

                    <input class="form-control" type="text" id="fnum" placeholder="Airport ID">
