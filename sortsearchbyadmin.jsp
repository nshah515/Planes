...
<head>
    ...
    <title>Sort Your Searches</title>
...
<form action="searchForFlightAdmin.jsp">
			...
			<div class="col-6 offset-3 card border rounded text-white mr-1"
				...
				<center>
					<h2 class="display-4 pt-5 pb-3">Search for flights based on your criteria</h2>
				</center>
				...
				<form method="post" action="sortsearchbyadmin.jsp">
...
<a href="searchForFlightAdmin.jsp"></a>
